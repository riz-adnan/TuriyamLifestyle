...
const ProdState = (props) => {
  ...
  const getProd = async () => {
    // API Call 
    const response = await fetch(`${host}/api/Pro/`, {
      method: 'GET',
  ...
  const getProdGen = async () => {
   ...
   const addProd = async (name, description, price,urltoimage,category) => {
    // TODO: API Call
    // API Call 
    const response = await fetch(`${host}/api/Pro/addprod`, {
      method: 'POST',
      headers: {
...
// post order
  ...
  const postorder = async (cart,refid,buyer,price)=>{
    const response = await fetch(`${host}/api/Orders/postorder`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
  ...
  const apporder = async (id,memberid)=>{
    const response= await fetch(`${host}/api/Orders/approveorder/${id}`,{
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        "auth-token": window.localStorage.getItem('token'),
  ...
  const deleteProd = async (id) => {
    // API Call
    const response = await fetch(`${host}/api/Pro/deleteprod/${id}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        "auth-token": window.localStorage.getItem('token')
  ...
  const editProd = async (id, name, description, price,urltoimage,category) => {
    // API Call 
    const response = await fetch(`${host}/api/Pro/updateprod/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        "auth-token": window.localStorage.getItem('token')
